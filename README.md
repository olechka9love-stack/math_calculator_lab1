...
1. ✅ Распознавание числовых литералов (целые и вещественные)
2. ✅ Распознавание идентификаторов переменных и функций
3. ✅ Распознавание операторов (+, -, *, /, =)
4. ✅ Распознавание разделителей (;, (, ))
5. ✅ Пропуск пробельных символов
6. ✅ Обработка выражений с переменными
7. ✅ Обработка выражений с функциями
8. ✅ Интерактивный режим тестирования
